...
<p style="text-align: justify;"><strong>1.1.</strong> Por una parte, '.$nombrePersonaJuridica.'<strong>, domiciliada en '.$ciudadDomicilio1.', </strong>con RUC '.$RUC.', mediante su representante legal '.$representanteLegal.', con '.$identificacionRepresentante.' de identidad No. '.$numeroIdentificacionRepresentante.', quien en adelante y para efectos de este contrato se lo conocer&aacute; como PARTE CONTRATANTE.</p>
<p style="text-align: justify;"><strong>1.2.</strong> Por otra parte, '.$nombrePersonaNatural.', con '.$identificacionPersonaNatural.' de identidad '.$numeroIdentificacionPersonaNatural.', de estado civil '.$estadoCivil.', nacionalidad '.$nacionalidad.', con domicilio en la ciudad de '.$ciudadDomicilio2.' y con direcci&oacute;n en '.$direccion.', quien en adelante y para efectos de este contrato se lo conocer&aacute; como PARTE CONTRATADA.</p>
...
<p style="text-align: justify;"><strong>4.1.</strong>&nbsp;Cancelar los honorarios profesionales de la PARTE CONTRATADA en la forma establecida en la Cl&aacute;usula Quinta de este contrato.</p>
<p style="text-align: justify;"><strong>4.2.</strong>&nbsp;Entregar toda la informaci&oacute;n solicitada por la PARTE CONTRATADA.</p>
...
<p style="text-align: justify;"><strong>6.1.</strong> El plazo del contrato se estipula en '.$plazoContrato.' meses. El contrato podr&iacute;a quedar autom&aacute;ticamente prorrogado si las partes t&aacute;citamente contin&uacute;an con su relaci&oacute;n contractual.</p>
...
$pdf->Output(__DIR__ .'/archivos/prestacion_servicios_pj_pn.pdf', 'F');
...
$mg->messages()->send('mailing.pilisimas.com', [
  ...
  'html'    => $html1,
  'attachment' => [
    ['filePath'=>'./archivos/prestacion_servicios_pj_pn.pdf']
  ]
]);
