...
$numeroIdentificacionRepresentante1 = $_POST['numeroIdentificacionRepresentante1'];

//Infomracion persona juridica2
$nombrePersonaJuridica2 =  $_POST['nombrePersonaJuridica2'];
$ciudadDomicilio2 =  $_POST['ciudadDomicilio2'];
$RUC2 = $_POST['RUC2'];
$representanteLegal2 =  $_POST['representanteLegal2'];
$identificacionRepresentante2 = $_POST['identificacionRepresentante2'];
$numeroIdentificacionRepresentante2 = $_POST['numeroIdentificacionRepresentante2'];
...
<p><strong>1.1.</strong> Por una parte, '.$nombrePersonaJuridica.'<strong>, domiciliada en '.$ciudadDomicilioVendedor.', </strong>con RUC '.$RUC.', mediante su representante legal '.$representanteLegalVendedor.', con '.$identificacionRepresentante1.' de identidad No. '.$numeroIdentificacionRepresentante1.'<strong>, </strong>quien en adelante y para efectos de este contrato se lo conocer&aacute; como PARTE CONTRATANTE.</p>
<p><strong>1.2.</strong> Por otra parte, '.$nombrePersonaJuridica2.'<strong>, domiciliada en </strong><strong> '.$ciudadDomicilio2.', </strong>con RUC '.$RUC2.', mediante su representante legal '.$representanteLegal2.', con '.$identificacionRepresentante2.' de identidad No. '.$numeroIdentificacionRepresentante2.'<strong>, </strong>quien en adelante y para efectos de este contrato se lo conocer&aacute; como PARTE CONTRATADA.</p>
<p>Los comparecientes son capaces para obligarse y contratar, intervienen en las calidades se&ntilde;aladas, por lo que convienen en celebrar el presente Contrato de Servicios Profesionales.</p>
...
<p><span style="background-color: #ffff00;"><strong>'.$nombrePersonaJuridica2.'</strong></span></p>
</td>
</tr>
</tbody>
</table>
...
$pdf->Output(__DIR__ .'/archivos/prestacion_servicios_pj_pj.pdf', 'F');
...
$mg->messages()->send('mailing.pilisimas.com', [
  ...
  'html'    => $html1,
  'attachment' => [
    ['filePath'=>'./archivos/prestacion_servicios_pj_pj.pdf']
  ]
]);
