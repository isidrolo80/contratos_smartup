...
$pdf->Output(__DIR__ .'/archivos/prestacion_servicios_pn_pj.pdf', 'F');
...
$mg->messages()->send('mailing.pilisimas.com', [
  ...
  'html'    => $html1,
  'attachment' => [
    ['filePath'=>'./archivos/prestacion_servicios_pn_pj.pdf']
  ]
]);
