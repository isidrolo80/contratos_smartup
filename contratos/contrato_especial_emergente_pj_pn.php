...
<p>1.1. Por una parte,'.$nombrePersonaJuridica.', domiciliada en '.$ciudadDomicilio1.', con RUC No. '.$RUC.', mediante su representante legal '.$representanteLegal.', con '.$identificacionRepresentante.' de identidad No. '.$numeroIdentificacionRepresentante.', quien en adelante y para efectos de este contrato se lo conocer&aacute; como EL EMPLEADOR.</p>
<p>1.2. Por otra parte,'.$nombrePersonaNatural.' con '.$identificacionPersonaNatural.' de identidad No. '.$numeroIdentificacionPersonaNatural.', de estado civil '.$estadoCivil.', nacionalidad '.$nacionalidad.', con domicilio en la ciudad de '.$ciudadDomicilio2.' y con direcci&oacute;n en '.$direccion.', quien en adelante y para efectos de este contrato se lo conocer&aacute; como EL TRABAJADOR.</p>
...
<p>9.2. Adem&aacute;s, se compromete a no cometer ning&uacute;n acto o acci&oacute;n que represente deslealtad hacia El EMPLEADOR, o que de manera directa o indirecta pudiera afectar El EMPLEADOR.</p>
...
$pdf->Output(__DIR__ .'/archivos/contrato_especial_emergente_pj_pn.pdf', 'F');
$mg->messages()->send('mailing.pilisimas.com', [
  ...
  'html'    => $html1,
  'attachment' => [
    ['filePath'=>'./archivos/contrato_especial_emergente_pj_pn.pdf']
  ]
]);
